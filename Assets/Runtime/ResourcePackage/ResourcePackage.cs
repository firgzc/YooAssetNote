...
namespace YooAsset
{
    ...
    public class ResourcePackage
    {
        ...
        public InitializationOperation InitializeAsync(InitializeParameters parameters)
        {
            ...
            if (_playMode == EPlayMode.EditorSimulateMode) //编辑器模式
            {
        ...
        {
            DebugCheckInitialize();
            _persistentMgr.DeleteSandboxPackageFolder(); //清空持久化的管理器中包裹
            _cacheMgr.ClearAll();  // 清空缓存
        }
        ...
        /// </summary>
        /// <param name="assetInfo">资源信息</param>
        /// <param name="waitForAsyncComplete">等待异步加载完成</param>
        ...
        /// </summary>
        /// <param name="assetInfo">资源信息</param>
        /// <param name="waitForAsyncComplete"></param>
        ...
        /// <param name="assetType">资源信息类</param>
