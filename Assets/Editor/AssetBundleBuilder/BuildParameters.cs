...
namespace YooAsset.Editor
{
    ...
    public abstract class BuildParameters
    {
        ...
        public virtual string GetPipelineOutputDirectory()
        {
            ...
            {
                _pipelineOutputDirectory = $"{BuildOutputRoot}/{PlatformUtility.GetPlatformSimple(BuildTarget)}/{PackageName}/{YooAssetSettings.OutputFolderName}";
            }
        ...
        public virtual string GetPackageOutputDirectory()
        {
            ...
            {
                _packageOutputDirectory = $"{BuildOutputRoot}/{PlatformUtility.GetPlatformSimple(BuildTarget)}/{PackageName}/{PackageVersion}";
            }
        ...
        public virtual string GetPackageRootDirectory()
        {
            ...
            {
                _packageRootDirectory = $"{BuildOutputRoot}/{PlatformUtility.GetPlatformSimple(BuildTarget)}/{PackageName}";
            }
