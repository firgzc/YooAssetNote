...
namespace YooAsset
{
    ...
    public static class PlatformUtility
    {
        ...
        {
#if UNITY_EDITOR
            return GetPlatformSimple(EditorUserBuildSettings.activeBuildTarget);
#else
        ...
        /// 输出构建平台的简短名称
        /// </summary>
        /// <param name="target">构建的目标平台</param>
        public static string GetPlatformSimple(BuildTarget target)
        {
            switch (target)
            {
                ...
                case BuildTarget.StandaloneLinux64:
                    return "Linux";
                //此处平台扩展
                // 如果您添加更多的目标，不要忘记向GetPlatformForAssetBundles(RuntimePlatform)方法添加相同的平台。
                default:
                    return null;
            }
        }
        ...
        /// 出包后的运行平台
        /// </summary>
        /// <param name="platform">运行的目标平台</param>
